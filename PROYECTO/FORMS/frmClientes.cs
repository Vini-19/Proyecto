    ...
    public partial class frmClientes : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else 
            {
                ...
                if (errorProvider1.GetError(txtRTN_Cliente) == "" && errorProvider1.GetError(txtDNI_Cliente) == "" && errorProvider1.GetError(txtNombre_Cliente) == "" && errorProvider1.GetError(txtTelefono_Cliente) == "" && errorProvider1.GetError(txtCorreo_Cliente) == "")
                {
        ...
        private void txtDireccion_Cliente_TextChanged(object sender, EventArgs e)
        {
