...
namespace PROYECTO {
    ...
    public partial class VENTAS : global::System.Data.DataSet {
        ...
        public partial class VentasDataTable : global::System.Data.TypedTableBase<VentasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public VentasRow AddVentasRow(System.DateTime FechaVenta, string Cliente, string RTN_Cliente, decimal Total) {
            ...
            private void InitClass() {
                ...
                this.columnRTN_Cliente.MaxLength = 50;
            }
        ...
        public partial class VentasRow : global::System.Data.DataRow {
            ...
            public string RTN_Cliente {
                get {
                    try {
                        return ((string)(this[this.tableVentas.RTN_ClienteColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'RTN_Cliente\' de la tabla \'Ventas\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableVentas.RTN_ClienteColumn] = value;
                }
            }
            ...
            public bool IsRTN_ClienteNull() {
                return this.IsNull(this.tableVentas.RTN_ClienteColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetRTN_ClienteNull() {
                this[this.tableVentas.RTN_ClienteColumn] = global::System.Convert.DBNull;
            }
...
namespace PROYECTO.VENTASTableAdapters {
    ...
    public partial class VentasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Ventas] WHERE (([ID_Venta] = @Original_ID_Venta) AND ((@IsNull_FechaVenta = 1 AND [FechaVenta] IS NULL) OR ([FechaVenta] = @Original_FechaVenta)) AND ((@IsNull_Cliente = 1 AND [Cliente] IS NULL) OR ([Cliente] = @Original_Cliente)) AND ((@IsNull_RTN_Cliente = 1 AND [RTN_Cliente] IS NULL) OR ([RTN_Cliente] = @Original_RTN_Cliente)) AND ((@IsNull_Total = 1 AND [Total] IS NULL) OR ([Total] = @Original_Total)))";
            ...
            param.ParameterName = "@IsNull_FechaVenta";
            param.DbType = global::System.Data.DbType.Int32;
            param.SqlDbType = global::System.Data.SqlDbType.Int;
            param.IsNullable = true;
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Original_FechaVenta";
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@IsNull_RTN_Cliente";
            param.DbType = global::System.Data.DbType.Int32;
            param.SqlDbType = global::System.Data.SqlDbType.Int;
            param.IsNullable = true;
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Original_RTN_Cliente";
            param.SqlDbType = global::System.Data.SqlDbType.NVarChar;
            param.IsNullable = true;
            param.SourceColumn = "RTN_Cliente";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Ventas] ([FechaVenta], [Cliente], [RTN_Cliente], [Total]) VALU" +
                "ES (@FechaVenta, @Cliente, @RTN_Cliente, @Total);\r\nSELECT ID_Venta, FechaVenta, " +
                "Cliente, RTN_Cliente, Total FROM Ventas WHERE (ID_Venta = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@RTN_Cliente";
            param.SqlDbType = global::System.Data.SqlDbType.NVarChar;
            param.IsNullable = true;
            param.SourceColumn = "RTN_Cliente";
            this._adapter.InsertCommand.Parameters.Add(param);
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Ventas] SET [FechaVenta] = @FechaVenta, [Cliente] = @Cliente, [RTN_Cliente] = @RTN_Cliente, [Total] = @Total WHERE (([ID_Venta] = @Original_ID_Venta) AND ((@IsNull_FechaVenta = 1 AND [FechaVenta] IS NULL) OR ([FechaVenta] = @Original_FechaVenta)) AND ((@IsNull_Cliente = 1 AND [Cliente] IS NULL) OR ([Cliente] = @Original_Cliente)) AND ((@IsNull_RTN_Cliente = 1 AND [RTN_Cliente] IS NULL) OR ([RTN_Cliente] = @Original_RTN_Cliente)) AND ((@IsNull_Total = 1 AND [Total] IS NULL) OR ([Total] = @Original_Total)));
SELECT ID_Venta, FechaVenta, Cliente, RTN_Cliente, Total FROM Ventas WHERE (ID_Venta = @ID_Venta)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_Venta, FechaVenta, Cliente, RTN_Cliente, Total FROM dbo.Ventas";
        ...
        public virtual int Delete(int Original_ID_Venta, global::System.Nullable<global::System.DateTime> Original_FechaVenta, string Original_Cliente, string Original_RTN_Cliente, global::System.Nullable<decimal> Original_Total) {
            ...
            if ((Original_RTN_Cliente == null)) {
                this.Adapter.DeleteCommand.Parameters[5].Value = ((object)(1));
                this.Adapter.DeleteCommand.Parameters[6].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.DeleteCommand.Parameters[5].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_RTN_Cliente));
            }
        ...
        public virtual int Insert(global::System.Nullable<global::System.DateTime> FechaVenta, string Cliente, string RTN_Cliente, global::System.Nullable<decimal> Total) {
            ...
            if ((RTN_Cliente == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(RTN_Cliente));
            }
        ...
        public virtual int Update(global::System.Nullable<global::System.DateTime> FechaVenta, string Cliente, string RTN_Cliente, global::System.Nullable<decimal> Total, int Original_ID_Venta, global::System.Nullable<global::System.DateTime> Original_FechaVenta, string Original_Cliente, string Original_RTN_Cliente, global::System.Nullable<decimal> Original_Total, int ID_Venta) {
            if ((FechaVenta.HasValue == true)) {
            ...
            if ((RTN_Cliente == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(RTN_Cliente));
            }
            if ((Total.HasValue == true)) {
            ...
            if ((Original_RTN_Cliente == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_RTN_Cliente));
            }
            if ((Original_Total.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<global::System.DateTime> FechaVenta, string Cliente, string RTN_Cliente, global::System.Nullable<decimal> Total, int Original_ID_Venta, global::System.Nullable<global::System.DateTime> Original_FechaVenta, string Original_Cliente, string Original_RTN_Cliente, global::System.Nullable<decimal> Original_Total) {
            return this.Update(FechaVenta, Cliente, RTN_Cliente, Total, Original_ID_Venta, Original_FechaVenta, Original_Cliente, Original_RTN_Cliente, Original_Total, Original_ID_Venta);
        }
    }
